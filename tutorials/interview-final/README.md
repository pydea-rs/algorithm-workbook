...
- **16 Practice Sets** (PS1–PS15, incl. PS2b) — every module has one, including the recap
  ...
  6-step template on)
- **90 questions** (F01–F90): 69 Python/JS coding, 10 runnable SQL, 11 discussion/design
- **Final Exam** dealing 12 questions from a curated 51-question pool — stratified to always
